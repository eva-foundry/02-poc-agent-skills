# GitHub Copilot Instructions -- Agent Skills Framework

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: Agent Skills Framework -- POC generalizing the EVA documentation generator into a reusable, composable agent skills framework for diverse AI automation tasks.
**Path**: `C:\AICOE\eva-foundry\02-poc-agent-skills\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/02-poc-agent-skills" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **02-poc-agent-skills** (Agent Skills Framework).
...
Once this file has been loaded, the active project is locked to **02-poc-agent-skills** for the entire session.
...
**Folder**: `C:\AICOE\eva-foundry\02-poc-agent-skills`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/02-poc-agent-skills`
**Maturity**: poc
**Phase**: Phase 1 -- POC Complete

**Depends on**:
- 01-documentation-generator -- [TODO: why]
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*02-poc-agent-skills*' } |
